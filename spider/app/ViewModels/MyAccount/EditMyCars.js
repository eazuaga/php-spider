function Car(data) {
    ...
    this.image = data.images != null ? (data.images[0] == "" || data.images[0] == undefined ? "img/not_available.jpg" : this.PathImage + data.images[0]) : "img/not_available.jpg";
}
...
//    var section = { 'EditMyCar': LoadEditMyCar, 'DeleteMyCar': LoadDeleteMyCar, 'InsertMyCar': LoadInsertMyCar, 'MyCars': LoadMyCars };
    ...
    Save = function () {
        ...
        console.log(params["EditMyCar"]);
        Repository.SendPost2("InventoryAll", params["EditMyCar"]);
        $("#Message").fadeIn();
    };
    //Delete = function () {
